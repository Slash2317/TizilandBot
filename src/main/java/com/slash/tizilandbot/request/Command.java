...
public enum Command {
    ...
    PING_IN("t!pingin", MODERATION, "Ghost ping new users in the specified channel", 0, List.of("channel")),
    REMOVE_PING_IN("t!removepingin", MODERATION, "Remove ghost ping in the specified channel", 0, List.of("channel")),
    VIEW_PING_IN("t!viewpingin", MODERATION, "Shows a list of channels ghost ping new users"),
    ...
    INVITE("t!invite", SERVER, "Shows invite links to Tiziland!!"),
