...
public enum Command {
    ...
    PING_IN("r!pingin", MODERATION, "Ghost ping new users in the specified channel", 0, List.of("channel")),
    REMOVE_PING_IN("r!removepingin", MODERATION, "Remove ghost ping in the specified channel", 0, List.of("channel")),
    VIEW_PING_IN("r!viewpingin", MODERATION, "Shows a list of channels ghost ping new users"),
